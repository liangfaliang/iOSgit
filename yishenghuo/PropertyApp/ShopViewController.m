...
@interface ShopViewController ()<JWCycleScrollImageDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UINavigationControllerDelegate, UIImagePickerControllerDelegate,UISearchBarDelegate,UITabBarControllerDelegate>{
    UIButton *leftBtn;
}
