...
@interface Diabetes2ViewController ()<SPPageMenuDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation Diabetes2ViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = JHbgColor;
    self.navigationBarTitle = @"2型糖尿病患者随访服务记录表";
...
//    症状体征
    NSArray *basicArr = @[@{@"key":@"jiating",
                          ...
                          @{@"section":@"   体征",
                            ...
                            @"child":@[@{@"name":@"血压",@"key":@"hd_BloodPressure"},
                                       ...
                                       @{@"name":@"足背动脉搏动",@"key":@"hd_ArterialPulsation"},
    ...
    NSArray *lifeArr = @[@{@"key":@"jiating",
                            @"child":@[@{@"name":@"日吸烟量",@"key":@"hd_DaySmoke1"},
                                       @{@"name":@"日饮酒量",@"key":@"hd_DayDrink1"},
                                       @{@"name":@"运动",@"key":@"hd_Motion1"},
                                       @{@"name":@"主食",@"key":@"hd_StapleFood1"},
                                       @{@"name":@"心理调整",@"key":@"hd_MentalAdjustment"},
                                       @{@"name":@"遵医行为",@"key":@"hd_Compliance"}]
                           },
                         @{@"key":@"jiating",
                           @"child":@[@{@"name":@"空腹血糖值",@"key":@"hd_FastingBloodGlucose"}]
                           },
                         @{@"key":@"jiating",
                           @"child":@[@{@"name":@"糖化血红蛋白",@"key":@"hg_BloodPressure"},
                                      @{@"name":@"检查日期",@"key":@"hg_Breast"},
    ...
    NSArray *useArr = @[@{@"key":@"hd_DrugName1",
                            @"child":@[@{@"name":@"服药依从性",@"key":@"hd_DrugCompliance"},
                                       ...
                                       @{@"name":@"低血糖反应",@"key":@"hd_HypoglycemicReaction"},
                                       @{@"name":@"此次随访分类",@"key":@"hd_FollowUpClassification"}]
                            }];
    ...
    for (int i = 0; i < 5; i ++) {
        NSString *hd_DrugName = [NSString stringWithFormat:@"hd_DrugName%d",i+1];
