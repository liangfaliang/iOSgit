...
- (NSString *)orderInfoEncodedEncode:(BOOL)bEncoded {
...
//                orderItem = [self orderItemWithKey:key andValue:[NSString stringWithFormat:@"\"%@\"",[tmpDict1 objectForKey:key]] encoded:bEncoded];
                
            
            NSString *value = [tmpDict objectForKey:key];
            orderItem = [self orderItemWithKey:key andValue:[NSString stringWithFormat:@"%@",value] encoded:bEncoded];
