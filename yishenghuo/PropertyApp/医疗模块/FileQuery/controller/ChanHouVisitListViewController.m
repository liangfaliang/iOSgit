//
//  ChanHouVisitListViewController.m
//  PropertyApp
//
...
#import "ChanHouVisitListViewController.h"
#import "FileIListTableViewCell.h"
#import "ChanHouVisitViewController.h"
@interface ChanHouVisitListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ChanHouVisitListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationBarTitle = @"产后访视记录列表";
    self.index = 0;
    [self initTableView];
    [self UpData];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{//个人基本信息表
    NSDictionary *model = self.dataArray[indexPath.row];
    ChanHouVisitViewController *VC = [[ChanHouVisitViewController alloc]init];
