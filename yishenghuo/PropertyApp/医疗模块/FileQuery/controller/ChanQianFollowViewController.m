//
//  ChanQianFollowViewController.m
//  PropertyApp
//
...
#import "ChanQianFollowViewController.h"
#import "SPPageMenu.h"
#import "TextFiledLableTableViewCell.h"
@interface ChanQianFollowViewController ()<SPPageMenuDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation ChanQianFollowViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = JHbgColor;
    self.navigationBarTitle = @"产前随访服务记录表";
...
-(void)InitializationData:(NSDictionary *)dict{
    //基本信息
    NSArray *basicArr = @[@{@"section":@"   产科检查",
                            @"image":@"yibanzhuangk",
                            @"key":@"jiating",
                            @"child":@[@{@"name":@"姓名",@"key":@"hp_name"},
                                       @{@"name":@"编号",@"key":@"hp_no"},
                                       @{@"name":@"随访日期",@"key":@"hc_FollowUpDate"},
                                       @{@"name":@"孕周",@"key":@"hc_GestationalWeek"},
                                       @{@"name":@"主诉",@"key":@"hc_MainComplaint"},
                                       @{@"name":@"体重",@"key":@"hc_Weight"}]
                            },
                          @{@"key":@"jiating",
                            @"child":@[@{@"name":@"宫底高度",@"key":@"hc_Fundus"},
                                       @{@"name":@"腹围",@"key":@"hc_AbdominalCircum"},
                                       @{@"name":@"胎位",@"key":@"hc_FetalPosition"},
                                       @{@"name":@"胎心率",@"key":@"hc_FetalHeartRate"}]
                            },
                          @{@"key":@"jiating",
                            @"child":@[@{@"name":@"血压",@"key":@"hc_BloodPressure"},
                                       @{@"name":@"血红蛋白",@"key":@"hc_Hemoglobin"},
                                       @{@"name":@"尿蛋白",@"key":@"hc_UrineProtein"},
                                       @{@"name":@"其他辅助检查",@"key":@"hc_Other"},
                                       @{@"name":@"分类",@"key":@"hc_Classification"}]
                            }];
    ...
    NSArray *dirtyArr = @[@{@"section":@"   指导",
                          ...
                          @{@"key":@"chati",
                            @"child":@[@{@"name":@"下次随访日期",@"key":@"hc_NextFollowUpDate"},
                                       @{@"name":@"随访医生",@"key":@"hc_FollowUpDoctor"}]
                            }];
