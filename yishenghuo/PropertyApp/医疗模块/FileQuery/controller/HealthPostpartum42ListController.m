//
//  HealthPostpartum42ListController.m
//  PropertyApp
//
...
#import "HealthPostpartum42ListController.h"
#import "FileIListTableViewCell.h"
#import "HealthPostpartum42ViewController.h"
@interface HealthPostpartum42ListController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HealthPostpartum42ListController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationBarTitle = @"产后42天健康检查记录列表";
    self.index = 0;
    [self initTableView];
    [self UpData];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.timeLb.text = model[@"hg_FollowUpDate"];
    return cell;
}

-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{//个人基本信息表
    NSDictionary *model = self.dataArray[indexPath.row];
    HealthPostpartum42ViewController *VC = [[HealthPostpartum42ViewController alloc]init];
    VC.dict = model;
