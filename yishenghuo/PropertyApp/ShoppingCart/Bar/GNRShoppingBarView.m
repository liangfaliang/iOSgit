...
- (void)updateBadgeValue:(NSInteger)value price:(float)price{
    ...
    if (value) {
        ...
        self.priceL.font = SYS_FONTBold(16);
    }else{
        self.priceL.textColor = JHmiddleColor;
        self.priceL.font = SYS_FONT(15);
    }
    //btn
    self.payBtn.backgroundColor = price?JHColor(20, 146, 2):[UIColor lightGrayColor];
