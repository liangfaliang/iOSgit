...
@interface GNRCountStepper ()
{
    ...
    CGFloat Width_Lab;
    CGRect BOUNDS_SIZE;
    void(^_block)(NSInteger count ,UIButton * btn);
...
- (void)installUI{
    ...
    [_subBtn setImage:[UIImage imageNamed:@"shuliangjian"] forState:UIControlStateNormal];
    ...
    [_addBtn setImage:[UIImage imageNamed:@"shuliangjia"] forState:UIControlStateNormal];
...
- (void)setStyle:(GNRCountStepperStyle)style{
    _style = style;
    [_subBtn setImage:[UIImage imageNamed:style==GNRCountStepperStyleGoodsList?@"shuliangjian":@"shuliangjian"] forState:UIControlStateNormal];
    [_addBtn setImage:[UIImage imageNamed:style==GNRCountStepperStyleGoodsList?@"shuliangjia":@"shuliangjia"] forState:UIControlStateNormal];
}
...
- (void)countChangedBlock:(void(^)(NSInteger count ,UIButton *btn))block{
    _block = nil;
    _block = [block copy];
}
