...
-(void)setHeaderDataForDict:(NSDictionary *)dt{
    [self.header setHeaderData:dt];
}
- (void)reloadData{
...
//    if (cell==nil) {
//        cell = [[[NSBundle mainBundle]loadNibNamed:@"ShopCartTableViewCell" owner:self options:nil] firstObject];
//    }
