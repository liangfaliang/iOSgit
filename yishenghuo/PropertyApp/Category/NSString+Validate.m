...
- (BOOL)isAreaCode
{
    NSString *str = [self substringToIndex:3];
    if (![str isEqualToString:@"010"]) {
        str = [self substringToIndex:4];
    }
    NSLog(@"%@",str);
...
- (NSString*)regex_areaCode_fourDigit
{
    ...
    // 05xx
    NSString *fourDigit05 = @"05([135]\\d|2[37]|4[36]|6[1-6]|7[0-91]|80|9[1-9])";
    // 06xx
