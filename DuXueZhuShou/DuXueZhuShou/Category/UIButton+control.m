...
objc_setAssociatedObject(self,@selector(isEffective),@(isEffective),OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
-(BOOL)isEffective{
...

{
    ...
    if([NSStringFromClass(self.class)isEqualToString:@"UIButton"] && !self.isEffective) {
