...
- (UIImage *)initWithName:(NSString *)imageName {
    if (imageName) {
...
- (UIImage *)image:(UIImageOrientation)orientation
{
    ...
    LFLog(@"newPic:%ld",(long)newPic.imageOrientation);
    return newPic;
}
@end
