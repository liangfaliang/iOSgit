...
#import "Diabetes2ListViewController.h"
#import "FileIListTableViewCell.h"
#import "Diabetes2ViewController.h"
@interface Diabetes2ListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation Diabetes2ListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationBarTitle = @"2型糖尿病患者随访服务列表";
    self.index = 0;
    [self initTableView];
    [self UpData];
}
