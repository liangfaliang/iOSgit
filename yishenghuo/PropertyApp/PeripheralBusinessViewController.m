//
//  PeripheralBusinessViewController.m
//  PropertyApp
//
...
#import "PeripheralBusinessViewController.h"
...
@interface PeripheralBusinessViewController ()<UITableViewDelegate,UITableViewDataSource,CLLocationManagerDelegate,sortLabelviewDelegate>{
...
@implementation PeripheralBusinessViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    PeripheralBusinessDetailViewController *detial = [[PeripheralBusinessDetailViewController alloc]init];
    if (self.isCarnival) {
        detial.isCarnival = self.isCarnival;
    }
