//
//  HealthFileCoverViewController.m
//  PropertyApp
//
...
#import "HealthFileCoverViewController.h"
#import "TextFiledLableTableViewCell.h"
@interface HealthFileCoverViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic, strong)UITableView *tableView;
@property(nonatomic, strong)NSMutableArray *dataArray;

@end

@implementation HealthFileCoverViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationBarTitle = @"健康档案封面";
...
-(void)InitializationData:(NSDictionary *)dict{
    ...
    NSArray *basicArr = @[@{@"key":@"",
                            @"child":@[@{@"name":@"档案编号",@"text":@"",@"key":@"hp_no"},
                                       ...
                                       @{@"name":@"联系电话",@"text":@"",@"key":@"hp_telp",@"textcolor":@"FF5050"}]
                            },
                          @{@"key":@"",
                            @"child":@[@{@"name":@"乡镇(街道)名称",@"text":@"",@"key":@"hp_Town_name"},
                                       @{@"name":@"村(居)委会名称",@"text":@"",@"key":@"hp_committee_name"}]
                            },
