...
- (void)drawTextInRect:(CGRect)rect
{
    ...
    CGSize textSize = [self.text boundingRectWithSize:(CGSize){self.width, CGFLOAT_MAX} options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
